...
def transient(t, max_k, mu = 0.035, rho = 1., L = 1., a = 1., omega = 1.): # computes the velocity vector of the transient flow at time t and initial u = 0
	s = sigma(mu, rho, L)
...
t = 1e3
print(periodic(t)-transient(t,20)) # should be (almost) zero